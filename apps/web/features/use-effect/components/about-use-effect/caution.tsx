...
function DoNotLifeCycle() {
  return (
    <>
      ...
      <Text>
        Reactはレンダリング時のマウントや更新などの区別はなく、現在のprops、stateに応じてDOMと同期しており、マウント/アップデート/アンマウントのようなメンタルモデルとは微妙に異なる。コンポーネントが初めてレンダリングされたかどうかで動作が異なるエフェクトを書くのは潮の流れに逆らって泳ぐようなもの。
      </Text>
    </>
  );
}
